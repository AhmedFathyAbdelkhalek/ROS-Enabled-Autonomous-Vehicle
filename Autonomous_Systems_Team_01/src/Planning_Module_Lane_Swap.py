...
while 1 and not rospy.is_shutdown():
  ...
  if (actual_position_and_vel.data[0] < 0.5):
    V_Des = 0.4
    Lane_Des = 0
  elif(actual_position_and_vel.data[0] >= 0.5) & (actual_position_and_vel.data[0] < 3):
      V_Des = 0.25
      Lane_Des = 0.3
  elif (actual_position_and_vel.data[0] >= 5) & (actual_position_and_vel.data[0] < 7):
    V_Des = 0.5
    Lane_Des = -0.25
  elif (actual_position_and_vel.data[0] >= 7) & (actual_position_and_vel.data[0] < 8.5):
    V_Des = 0.25
    Lane_Des = 0.3
