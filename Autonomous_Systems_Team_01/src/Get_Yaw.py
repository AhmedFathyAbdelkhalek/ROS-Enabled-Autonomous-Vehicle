...
class MPU:
    ...
    def compFilter(self):
        ...
        # accYaw = math.degrees(math.atan2(self.ax, self.ay))
        ...
        #self.yaw = (self.tau)*(self.yaw + self.gz*dt) + (1-self.tau)*(accYaw)

        # Print data
        # print(" R: " + str(round(self.roll,1)) \
        #     + " P: " + str(round(self.pitch,1)) \
        #     + " Y: " + str(round(self.yaw,1)))
        print(" Yaw: " + str(round(self.yaw,1)))
        return self.yaw
    

pub = rospy.Publisher("actual_heading", Float32 , queue_size =1)
